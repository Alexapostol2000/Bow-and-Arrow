...
void Vis2D::Init()
{
	...
	Mesh* square1 = Obj2D::CreateSquare("square1", corner, length,0, glm::vec3(1, 0, 0));
...
void Vis2D::DrawScene(glm::mat3 visMatrix)
{
	modelMatrix = visMatrix * Trans2D::Translate(0, 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Trans2D::Translate(3, 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Trans2D::Translate(1.5, 1.5);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Trans2D::Translate(0, 3);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Trans2D::Translate(3, 3);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);
}
...
void Vis2D::OnInputUpdate(float deltaTime, int mods)
{
	...
	{
		GLfloat zoomAmount = deltaTime * 7;
